...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients(self):
        ...
        Ingredient.objects.create(user=self.user, name='Gin')
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=user2, name='Beer_lover')
    ...
    def test_retrieve_ingredients_assigned_to_recipe(self):
        ...
        ingredient1 = Ingredient.objects.create(user=self.user, name = 'Rum')
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        """Testing filtering ingredients by assigned return unique items"""
        ingredient = Ingredient.objects.create(user=self.user, name='Rum')
        Ingredient.objects.create(user=self.user, name='Gin')
